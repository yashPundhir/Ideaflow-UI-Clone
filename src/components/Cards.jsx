	...
	return (
		<div className="flex flex-col md:flex-row justify-center flex-wrap gap-10 items-center md:px-28 max-w-7xl mx-auto py-10">
			{testimonials.map((item, index) => (
				<Tilt key={index}>
					<div className="flex flex-col justify-center items-start gap-8 w-[320px] border-2 border-blue-600 bg-[#101010] rounded-2xl px-7 py-5 cursor-pointer hover:shadow-[0px_0px_30px_18px_#0018b7] transition ease-in-out duration-500">
