...
const Puzzles = () => {
	return (
		<div className="flex flex-col md:flex-row justify-center md:gap-20 gap-10 items-center md:px-28 px-20 max-w-7xl mx-auto py-10">
			...
			<div className="flex flex-col justify-center md:items-start items-center gap-2 xl:w-[350px] lg:w-[280px] md:w-[220px] w-full px-12 md:px-0">
				<h1 className="lg:text-[40px] md:text-[32px] text-center md:text-left text-[25px] leading-[45px] ">
					Connecting people with matching puzzle pieces
				</h1>

				<div className="border-2 border-white xl:w-[335px] lg:w-[250px] md:w-[200px] w-full mt-3 mb-5 "></div>
