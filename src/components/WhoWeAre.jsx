...
const WhoWeAre = () => {
	return (
		<div className="flex flex-col-reverse md:flex-row justify-center md:gap-16 gap-10 items-center md:px-32 px-5 max-w-7xl mx-auto pb-10 pt-20">
			<div className="flex flex-col justify-center md:items-start items-center gap-2 lg:w-1/2 w-auto ">
				<h1 className="text-[40px] leading-[45px] px-5 md:px-0 text-center md:text-left  ml-0 md:ml-5">
					Who we are
				</h1>

				<div className="border-2 border-white w-[220px] mt-0 mb-5 ml-0 md:ml-5"></div>
				<p className="text-xl leading-6 font-normal text-center md:text-left lg:w-[380px] md:w-[300px] w-auto px-8 md:px-5 mb-5">
			...
			<div className="lg:w-1/2 w-auto ">
				<Tilt>
					<div className="flex flex-col gap-5  lg:w-[450px] md:w-[380px] w-[320px] border-2 border-blue-600 bg-[#101010] rounded-2xl px-10 py-10 cursor-pointer hover:shadow-[0px_0px_30px_18px_#0018b7] transition ease-in-out duration-500">
