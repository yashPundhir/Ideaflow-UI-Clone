...
const WhoWeAre = () => {
	return (
		<div className="flex flex-col-reverse md:flex-row justify-center md:gap-20 gap-10 items-center md:px-32 max-w-7xl mx-auto pb-10 pt-20">
			<div className="flex flex-col justify-center items-start gap-2 w-1/2 ">
				<h1 className="text-[40px] leading-[45px] ">Who we are</h1>

				<div className="border-2 border-white w-[220px] mt-0 mb-5"></div>
				<p className="text-xl leading-6 font-normal w-[380px] mb-5">
			...
			<div className="w-1/2 ">
				<Tilt>
					<div className="flex flex-col gap-5  w-[450px] border-2 border-blue-600 bg-[#101010] rounded-2xl px-10 py-10 cursor-pointer hover:shadow-[0px_0px_30px_18px_#0018b7] transition ease-in-out duration-500">
						<div className="flex justify-start items-center gap-8 ">
							<div className=" w-1/4">
								<img className="w-[100px]" src={pol1} alt="testimonial-image" />
							</div>
						...
						<div className="flex justify-start items-center gap-8 ">
							<div className="w-1/4">
								<img className="w-[100px]" src={pol2} alt="testimonial-image" />
							</div>
							<div className="flex flex-col w-3/4  items-start justify-center gap-1 ">
								<p className="text-[22px] font-normal">
						...
						<div className="flex justify-start items-center gap-8 ">
							<div className="w-1/4">
								<img className="w-[100px]" src={pol3} alt="testimonial-image" />
							</div>
							<div className="flex flex-col w-3/4 items-start justify-center gap-1 ">
								<p className="text-[22px] font-normal">
